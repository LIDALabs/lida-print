...
1. Copiar la carpeta **`lida-print`** a `C:\` (o cualquier ruta), resultando en `C:\lida-print\` (o `C:\AutoPrintFacturas\`, como prefiera).
2. Abrir PowerShell **como Administrador**.
3. Ejecutar:
   ```powershell
   powershell -ExecutionPolicy Bypass -File "C:\lida-print\Install.ps1"
   ```
4. Seguir las instrucciones. Al terminar, el Configurator se abre solo.
